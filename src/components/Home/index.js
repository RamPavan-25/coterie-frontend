    ...
    <div className='Our-categories'>
      ...
      <div className='our-category-first-div'>
        <div className='category-card'>
          <img src="https://i.ibb.co/g93PJPN/shirt-mockup-concept-with-plain-clothing.jpg" className='categorie-images'/>
        ...
        <div className='category-card'>
          <img src="https://i.ibb.co/fxKS1qd/2106-q703-016-S-m004-c10-household-appliance-realistic.jpg" className='categorie-images'/>
          <div className='category-inside-container'>
        ...
        <div className='category-card'>
          <img src="https://i.ibb.co/5MvSjPQ/modern-kitchen-equipment-shining-steel-appliances-gleam-generated-by-ai.jpg" className='categorie-images'/>
          <div className='category-inside-container'>
      ...
      <div className='our-category-first-div second-div-margin'>
        <div className='category-card'>
          <img src="https://i.ibb.co/cb4nFYF/close-up-woman-closing-jar-with-organic-pasta.jpg" className='categorie-images'/>
          <div className='category-inside-container'>
        ...
        <div className='category-card'>
          <img src="https://i.ibb.co/Ch4Qmj8/front-view-kid-playing-with-wooden-toyds.jpg" className='categorie-images'/>
          <div className='category-inside-container'>
